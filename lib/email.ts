...
export async function sendWelcomeEmail(email: string, name: string) {
  ...
  await transport.sendMail({
    ...
    text: `Hi ${name},\n\nWelcome to PrepMate! Your account is all set up and you're ready to start studying smarter.\n\nPrepMate uses artificial intelligence to help you generate study plans, summarise complex topics, and create custom quizzes — all tailored to your courses and exam dates.\n\nHere's what you can do:\n- Generate personalised study plans\n- Summarise difficult topics with AI\n- Create practice quizzes to test your knowledge\n- Track your progress over time\n\nHead over to your dashboard to get started: ${process.env.NEXTAUTH_URL}/chatmate\n\nHappy studying,\nThe PrepMate Team`,
    html: `<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
      <h1 style="font-size: 24px; color: #1a1a2e; margin: 0 0 8px;">Welcome to PrepMate!</h1>
      ...
      <p style="font-size: 16px; color: #555; margin: 0 0 16px;">PrepMate uses artificial intelligence to help you generate study plans, summarise complex topics, and create custom quizzes — all tailored to your courses and exam dates.</p>
      ...
      <p style="font-size: 14px; color: #888; margin-top: 24px;">Happy studying,<br>The PrepMate Team</p>
    </div>`,
  });
}
