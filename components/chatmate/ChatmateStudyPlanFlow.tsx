...
export function ChatmateStudyPlanFlow({ onBack }: ChatmateStudyPlanFlowProps) {
  ...
  const sidebarLeft = isMobile ? "0" : state === "collapsed" ? "3rem" : "14rem";
  ...
  return (
    <div className="flex-1 flex flex-col items-center w-full animate-in fade-in duration-300 overflow-x-hidden">
      <div className="fixed top-0 z-50 bg-sidebar/50 backdrop-blur-md right-0 flex justify-center pt-2" style={{ left: sidebarLeft }}>
        <div className="w-full px-4 md:px-0 flex flex-col gap-4 md:max-w-[60%]">
      ...
      <div className="flex-1 flex flex-col w-full max-sm:pt-12 pt-8">
        {step === "COURSE_COUNT" && (
        ...
        {step === "COURSE_DETAILS" && (
          <>
            <div className="w-full flex justify-center">
              <div className="w-full flex flex-col items-center space-y-10 pb-24 pt-6 md:max-w-[60%]">
            ...
            <div className="fixed bottom-0 z-10 bg-sidebar/50 backdrop-blur-md py-4 right-0 flex justify-center" style={{ left: sidebarLeft }}>
              <div className="w-full px-4 md:px-0 flex justify-end md:max-w-[60%]">
