                    ...
                    <CardContent>
                      <div className="flex flex-col gap-2">
                        {q.options.map((opt, j) => {
                          ...
                          let optClass = "rounded-lg border border-border px-3 py-2.5 text-body-small text-left";
                      ...
                      <p className="mt-3 text-body-small text-muted-foreground border-t border-border pt-3">
